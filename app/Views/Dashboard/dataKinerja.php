                                    ...
                                    <?php foreach ($list_pegawai as $list) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-primary" id="open-modal-hapus" data-toggle="modal" data-target="#modal-hapus" data-link="<?= base_url('/deleteLaporanKegiatan/' . $list['id']); ?>"> <span>Detail</span></button>
                                            </td>
                                        </tr>
